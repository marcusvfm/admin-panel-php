...
$pageName = "Pesquisa do Portfólio";
$sproject = filter_var($_GET['sproject'], FILTER_SANITIZE_STRIPPED);
if ($sproject) {
    ?>
    <!doctype html>
    <html lang="pt-br">
        ...
        <div class="main_container">
            <div class="main_container_left">
                <form class="form_search_user" action="searchproject.php" method="get">
                    <input type="text" name="sproject" id="sproject" value="<?= $sproject ?>"placeholder="Digite o nome do projeto"/>
            ...
            <div class="main_container_right">
                <div class="box">
                    ...
                    <?php
                    $portfolio = $pdo->prepare("SELECT * FROM portfolio WHERE name LIKE CONCAT('%', :search, '%')");
                    $portfolio->bindParam(":search", $sproject, PDO::PARAM_STR);
                    $portfolio->execute();
